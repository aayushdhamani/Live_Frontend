...
export const loginuser =(input)=>{
    ...
    return (dispatch)=>{
        ...
        fetch(`https://web-production-2864.up.railway.app/api/auth/createuser`, {
         method: "POST",
         headers: {
...
export const signItUp=(navigate,field)=>{
    return  (dispatch)=>{
        const { email, password} = field;
         ...
         fetch(`https://web-production-2864.up.railway.app/api/auth/login`, {
          method: "POST",
          headers: {
            "content-type": "application/json",
          },
...
export const DoctorData=(feilds)=>{
  ...
  return(dispatch)=>{
    ...
    fetch(`https://web-production-2864.up.railway.app/api/notes/addnote`, {
     method: "POST",
     headers: {
       "content-type": "application/json",
...
export const notesData=()=>{
  // debugger
  return(dispatch)=>{
    fetch(`https://web-production-2864.up.railway.app/api/notes/fetchallnotes`, {
...
export const SearchDatas=(feilds)=>{
  ...
  return(dispatch)=>{
    const { schema} = feilds;
    fetch(`https://web-production-2864.up.railway.app/api/health/healthId`, {
...
export const editData=(feilds)=>{
  ...
  return(dispatch)=>{
    ...
    // debugger;
    fetch(`https://web-production-2864.up.railway.app/api/notes/updatenote/${(_id).replaceAll('"', "")}`, {
   method: "PUT",
   headers: {
     "content-type": "application/json",
     "Authorization": localStorage.getItem(`Authorization`).replaceAll('"', ""),
...
export const deletData =(feilds)=>{
  ...
  return(dispatch)=>{
    const{_id}=feilds
    fetch(`https://web-production-2864.up.railway.app/api/notes/deletenote/${_id}`, {
   method: "DELETE",
   headers: {
     "content-type": "application/json",
     "Authorization": localStorage.getItem(`Authorization`).replaceAll('"', ""),
...
export const SaveImage=(feilds)=>{
  ...
  return(dispatch)=>{
    ...
    console.log(image);
    fetch(`https://web-production-2864.up.railway.app/api/Image/saveimage`, {
      method: "POST",   
      headers: {
...
export const deletImages=(feilds)=>{
  return(dispatch)=>{
    // debugger;
    const{_id}=feilds
    fetch(`https://web-production-2864.up.railway.app/api/Image/deleteImage/${_id}`, {
   method: "DELETE",
   headers: {
     "content-type": "application/json",
     "Authorization": localStorage.getItem(`Authorization`).replaceAll('"', ""),
...
export const pdfData=(feilds)=>{
  ...
  return(dispatch)=>{
    ...
    console.log(image);
    fetch(`https://web-production-2864.up.railway.app/api/pdf/savePdf`, {
      method: "POST",   
      headers: {
...
export const PdfDataGet=(feilds)=>{
  ...
  // debugger
  return(dispatch)=>{
    fetch(`https://web-production-2864.up.railway.app/api/pdf/getallPdf/${schema}`, {
...
export const UserData=(feilds)=>{
  ...
  return(dispatch)=>{
    ...
    fetch(`https://web-production-2864.up.railway.app/api/auth/UserInformation/${_id}`, {
      method: "PUT",   
      headers: {
        "content-type": "application/json",
        'Authorization': localStorage.getItem(`Authorization`).replaceAll('"', '')
...
export const UserInformationData=()=>{
  // debugger
  return(dispatch)=>{
    fetch(`https://web-production-2864.up.railway.app/api/information/fetchallData`, {
...
export const Gettingdata=()=>{
  // debugger
  return(dispatch)=>{
    fetch(`https://web-production-2864.up.railway.app/api/auth/getuser`, {
...
export const UpdatName=(feilds)=>{
  ...
  debugger
  return(dispatch)=>{
    fetch(`https://web-production-2864.up.railway.app/api/auth/updatename/${_id}`, {
